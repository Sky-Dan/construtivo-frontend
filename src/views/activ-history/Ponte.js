...
import PerguntasPonte3 from './forms/formQuestionsPonte3';
import PerguntasPonte6 from './forms/formQuestionsPonte6';
import PerguntasPonte10 from './forms/formQuestionsPonte10';
  ...
  return (
    <div id="dashboard-ecommerce">
        ...
        <Col x1="4" md="4" xs="12">
          ...
          <Row>
            ...
            <Col xl="6" md="6" xs="6">
              <Button
                color="primary"
                href="/activ-history/grades-ponte-history"
              >
                Ver Notas
              </Button>
            </Col>
      ...
      <Collapse isOpen={isOpen3}>
        <PerguntasPonte3 id="3" />
      </Collapse>
      <Collapse isOpen={isOpen6}>
        <PerguntasPonte6 id="6" />
      </Collapse>
      <Collapse isOpen={isOpen10}>
        <PerguntasPonte10 id="10" />
      </Collapse>
      <hr />
    </div>
  );
